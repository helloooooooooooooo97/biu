...
test('brand mascot lives at the corner; sidebar head is title plus collapse', () => {
  ...
  assert.match(css, /\.sidebar-brand-name\s*\{/)
  ...
  assert.match(css, /\.chat-view-header-expand\s*\{[^}]*color:\s*var\(--dsw-icon-active\)/s)
  assert.match(css, /\.chat-view-header-expand:hover\s*\{[^}]*color:\s*var\(--dsw-icon-active\)/s)
  assert.match(css, /\.chat-view-header-expand\.is-active\s*\{[^}]*color:\s*var\(--dsw-icon-active\)/s)
  assert.match(css, /\.chat-view-project\s*\{[^}]*color:\s*var\(--dsw-sidebar-fg\)/s)
  assert.match(css, /\.chat-view-project-icon\s*\{[^}]*color:\s*var\(--dsw-icon-active\)/s)
  assert.match(css, /\.chat-view-session-title\s*\{[^}]*color:\s*var\(--dsw-sidebar-fg-active\)/s)
  assert.match(css, /\.chat-view-session-title\s*\{[^}]*font-weight:\s*500/s)
  assert.match(css, /\.chat-view-session-title-pop\s*\{[^}]*background:\s*var\(--dsw-sidebar\)/)
  assert.match(css, /\.chat-view-session-title-pop\s*\{[^}]*border:\s*0/)
  assert.match(css, /\.chat-view-session-title-input\s*\{[^}]*background:\s*transparent/)
  assert.match(css, /\.chat-view-session-title-input\s*\{[^}]*border:\s*0/)
  assert.match(css, /\.inspector-tab\s*\{[^}]*color:\s*var\(--dsw-sidebar-fg\)/s)
  assert.match(css, /\.inspector-tab\.is-active\s*\{[^}]*color:\s*var\(--dsw-sidebar-fg-active\)/s)
