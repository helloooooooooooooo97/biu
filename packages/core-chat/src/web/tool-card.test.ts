...
test('tool panels match the step bar: sidebar fill, no border', () => {
  ...
  assert.match(css, /\.tool-call-head\.is-running \.tool-call-title/)
  ...
  assert.match(css, /\.tool-call-copy,\s*\.chat-code-copy/)
  assert.match(css, /\.chat-reply-block:hover \.tool-call-copy/)
