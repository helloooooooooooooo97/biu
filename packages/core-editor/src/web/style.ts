...
.page-block-handle-grip:hover,.page-block-handle-grip:focus-visible{background:var(--dsw-hover);color:var(--dsw-icon)}
...
.page-editor .page-block-missing-enable:hover{background:var(--dsw-hover);color:var(--dsw-icon)}
