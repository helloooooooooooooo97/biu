...
test('list and detail share the chat column max width with side padding', () => {
  ...
  assert.match(css, /\.fsdb-page \.tasks-search-wrap\{[^}]*color:var\(--dsw-icon-active\)/)
  assert.match(css, /\.fsdb-page \.tasks-refresh,\.fsdb-page \.tasks-sort-btn\{[^}]*color:var\(--dsw-icon-active\)/)
