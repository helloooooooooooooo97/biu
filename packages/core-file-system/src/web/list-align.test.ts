...
test('list and detail share the chat column max width with side padding', () => {
  ...
  assert.match(css, /\.fsdb-page \.tasks-th svg\{[^}]*color:var\(--dsw-icon\)/)
  assert.match(css, /\.fsdb-page \.tasks-th\.is-on svg\{[^}]*color:var\(--dsw-icon-active\)/)
  ...
  assert.match(css, /\.fsdb-crumb svg,\.fsdb-crumb-btn svg\{[^}]*color:var\(--dsw-icon\)/)
