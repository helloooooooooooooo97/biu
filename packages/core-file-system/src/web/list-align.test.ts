...
test('list and detail share the chat column max width with side padding', () => {
  ...
  assert.match(css, /\.fsdb-crumb-btn\{[^}]*color:var\(--dsw-sidebar-fg\)/)
  assert.match(css, /\.fsdb-crumb:last-child \.fsdb-crumb-btn,\.fsdb-crumb:last-child \.fsdb-crumb-btn:hover,\.fsdb-crumb:last-child \.fsdb-crumb-btn\.is-open\{[^}]*color:var\(--dsw-sidebar-fg-active\)/)
