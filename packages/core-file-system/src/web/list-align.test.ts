...
test('selected table cells use Super Tag blue when writable and gray when locked', () => {
  ...
  assert.match(css, /\.fsdb-page \.tasks-table:not\(\.is-wrap\) \.fsdb-person-list\{[^}]*flex-wrap:wrap/)
  assert.match(css, /\.fsdb-page \.tasks-table\.is-truncate:not\(\.is-wrap\) td:has\(\.fsdb-person-list\) \.fsdb-cell[\s\S]*?overflow:hidden/)
  assert.match(css, /\.fsdb-page \.tasks-table\.is-truncate:not\(\.is-wrap\) td:has\(\.fsdb-person-list\) \.fsdb-cell[\s\S]*?max-height:2\.8em/)
  assert.match(css, /\.fsdb-page \.tasks-table\.is-wrap \.fsdb-person-list\{[^}]*flex-wrap:wrap/)
