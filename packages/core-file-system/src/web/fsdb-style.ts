...
.heading-outline-host{position:absolute;inset:0 auto 0 0;width:32px;z-index:20;pointer-events:none;overflow:visible}
...
.heading-outline-host .chat-outline::before{inset:-24px auto -24px 0;width:24px}
...
.fsdb-share-page .fsdb-banner-story,.fsdb-share-page .fsdb-banner-title-actions{left:var(--fsdb-share-pad);max-width:calc(100% - 2 * var(--fsdb-share-pad))}
