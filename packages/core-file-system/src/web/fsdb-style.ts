...
.heading-outline-host .chat-outline::before{inset:-16px auto -16px -8px;width:32px}
...
.fsdb-page-banner{position:relative;flex:none;box-sizing:border-box;width:100%;margin:0;height:240px;overflow:hidden;background:var(--dsw-bubble);border-radius:0;z-index:2}
...
.fsdb-banner-title-actions{position:absolute;left:auto;right:80px;bottom:10px;z-index:3;display:flex;align-items:center;margin:0;min-height:0;opacity:0;pointer-events:none}
...
.fsdb-detail-icon-slot{position:relative;z-index:3;width:max-content;margin:-42px 0 8px;pointer-events:auto}
...
.fsdb-detail-title-icon svg{width:48px;height:48px;color:var(--dsw-icon)}
...
.fsdb-detail-title-icon .fsdb-record-mark.is-lg{width:78px;height:78px}
...
.fsdb-share-page .fsdb-banner-story{left:var(--fsdb-share-pad);max-width:calc(100% - 2 * var(--fsdb-share-pad))}
.fsdb-share-page .fsdb-banner-title-actions{left:auto;right:var(--fsdb-share-pad)}
