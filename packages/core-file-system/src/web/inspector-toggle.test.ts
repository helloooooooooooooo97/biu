...
test('database extras sit after the record detail, not in the inspector', () => {
  ...
  assert.match(style, /\.fsdb-banner-title-actions\{[^}]*top:16px/)
  assert.match(style, /\.fsdb-banner-title-actions\{[^}]*opacity:0/)
  assert.match(style, /\.fsdb-banner-story\{[^}]*right:80px/)
  assert.match(style, /\.fsdb-banner-story\{[^}]*top:52px/)
  ...
  assert.doesNotMatch(style, /\.fsdb-banner-story\{[^}]*left:80px/)
