...
test('database extras sit after the record detail, not in the inspector', () => {
  ...
  assert.match(browser, /<BannerTitleActions/)
  assert.match(detail, /<BannerTitleActions/)
  assert.match(style, /\.fsdb-page-banner\{[^}]*height:240px/)
  assert.match(style, /\.fsdb-page-banner\.is-empty\{[^}]*height:80px/)
  assert.match(style, /\.fsdb-detail-icon-slot\{[^}]*z-index:24/)
  assert.match(style, /\.fsdb-detail-icon-slot\{[^}]*justify-content:space-between/)
  assert.match(style, /\.fsdb-banner-title-actions\{[^}]*position:static/)
  assert.match(style, /\.fsdb-banner-title-actions\{[^}]*min-height:78px/)
  assert.doesNotMatch(style, /\.fsdb-banner-title-actions\{[^}]*right:80px/)
